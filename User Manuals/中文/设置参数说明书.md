...
background_transparency: 背景图片的透明度, 从 0 到 255 (透明到不透明)
...
current_detect_key_algorithm: 使用的调性分析算法，目前有两种算法可供选择，对应的值为0和1

major_minor_preference: 当前调性分析功能的配置参数，是否将大调和小调作为最可能的结果

most_appear_num: 当前调性分析功能的配置参数，可能出现的调性的数量
